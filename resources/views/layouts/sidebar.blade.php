<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    ...
    <div class="sidebar-brand">
        <a href="{{ url('/dashboard') }}" class="brand-link">
            <img src="{{ asset('assets/img/lanmiclogo.png') }}" alt="Lanmic Logo"
            ...
            <ul class="nav sidebar-menu flex-column" role="navigation" aria-label="Main navigation">
                ...
                <li class="nav-item">
                    <a href="./generate/theme.html"
                        class="nav-link {{ request()->is('generate/theme.html') ? 'active' : '' }}">
                        <i class="nav-icon bi bi-gear-fill {{ request()->is('generate/theme.html') ? 'text-primary' : 'text-muted' }}"></i>
                        <p>System Access</p>
                    </a>
                </li>
                ...
                <li class="nav-item masterfiles-menu {{ request()->routeIs('Masterfile.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link masterfiles-toggle {{ request()->routeIs('Masterfile.*') ? 'active' : '' }}">
                        <i class="nav-icon bi bi-folder-fill {{ request()->routeIs('Masterfile.*') ? 'text-primary' : 'text-muted' }}"></i>
                        <p>
                            Master Files
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('Masterfile.userlevel') }}"
                                ...
                                <i class="nav-icon bi bi-circle {{ request()->routeIs('Masterfile.userlevel') ? 'text-primary' : 'text-muted' }}"></i>
                                <p>User Levels</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('Masterfile.users') }}"
                                ...
                                <i class="nav-icon bi bi-circle {{ request()->routeIs('Masterfile.users') ? 'text-primary' : 'text-muted' }}"></i>
                                <p>Users</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('Masterfile.centers') }}"
                                ...
                                <i class="nav-icon bi bi-circle {{ request()->routeIs('Masterfile.centers') ? 'text-primary' : 'text-muted' }}"></i>
                                <p>Centers</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('Masterfile.vehicles') }}"
                                ...
                                <i class="nav-icon bi bi-circle {{ request()->routeIs('Masterfile.vehicles') ? 'text-primary' : 'text-muted' }}"></i>
                                <p>Vehicles</p>
                            </a>
                        </li>
