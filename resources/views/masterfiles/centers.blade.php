...
<main class="app-main">
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Centers Management</h3>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <tbody>
                                        @foreach($centers as $center)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="accordion accordion-flush" id="accordionFlush{{ $center->id }}">
                                                        <div class="accordion-item">

                                                            <h2 class="accordion-header" id="flush-heading{{ $center->id }}">
