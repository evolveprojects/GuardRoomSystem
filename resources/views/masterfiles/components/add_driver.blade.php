<div class="modal fade" id="add-driver-modal" tabindex="-1" role="dialog">
...
<script>
    $(document).ready(function () {
        $('#add-driver-modal').on('shown.bs.modal', function () {
            $('.select2').select2({
                dropdownParent: $('#add-driver-modal .modal-content'),
                width: '100%'
            });
        });
